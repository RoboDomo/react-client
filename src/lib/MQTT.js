...
class MQTT extends EventEmitter {
  ...
  connect() {
    ...
    //    this.host = "nuc1"; // process.env.REACT_APP_MQTT_HOST || "robodomo";
    this.host = process.env.REACT_APP_MQTT_HOST || "nuc1";
    this.port = process.env.REACT_APP_MQTT_PORT || 80;
    console.log("connecting", process.env, this.host, this.port);
